...
<body>		
		 <form id="selectHuman" name="selectHuman" method="POST">
			...
			<input type="button" name="selectappt" id="selectappt" value="개인인사발령 조회">
			<input type="button" name="selectapptAll" id="selectapptAll" value="전체인사발령 조회">
			<input type="button" name="commuteRecord" id="commuteRecord" value="출퇴근 기록 조회">
			<input type="button" name="deptCommRecord" id="deptCommRecord" value="출퇴근 기록 조회/변경">
